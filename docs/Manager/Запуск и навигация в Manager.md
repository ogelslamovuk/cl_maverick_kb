...
| **Настройки** | роли, права пользователей, баннеры сайта, пользовательские страницы, HTML-шаблоны и служебные таблицы |
...
Для отмены опубликованного сеанса или события с обработкой интернет-продаж см. [Массовая отмена сеансов и событий в Manager](../Расписание%20и%20события/Массовая%20отмена%20сеансов%20и%20событий%20в%20Manager.md).
