...
В Manager есть справочники, связанные с комплектацией и графиками смен, но по видео они не используются в текущем активном процессе.
...
!!! warning "Исторический раздел"
    По текущему источнику эти справочники не используются в активной работе. Не настраивай через них новый процесс без отдельного подтверждения.
