...
По видео подтверждены виды продаж:
...
Пример из объяснения: если кассе привязана зона только с билетами и сертификатами, на этой кассе не должны отображаться продукты и комбо.
