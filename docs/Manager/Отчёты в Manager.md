...
Если нужно разобрать конкретную операцию по оплатам, скидкам или статусу, используй не только отчёты, но и таблицу **Продажи** в Manager. См. [Проверка продаж в Manager](Проверка%20продаж%20в%20Manager.md).
...
**Предоплата (билеты)** используется для проверки билетных предоплат. Пользователи могут искать этот раздел как «предоплата билеты» или «отчёт по предоплатам».
