...
Если сеанс или событие нужно отменить после старта продаж, используй отдельную инструкцию по массовой отмене и возвратам. Перед возвратом затронутые сеансы нужно снять с публикации в расписании.
...
- [Массовая отмена сеансов и событий в Manager](Массовая%20отмена%20сеансов%20и%20событий%20в%20Manager.md)
