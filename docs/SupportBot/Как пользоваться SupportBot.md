...
## Что делать на шагах input

На шаге `input` бот просит написать текст. Текст нужно отправлять одним сообщением и не дробить на несколько частей.

![support_bot_input_example.png](../assets/media/support_bot/support_bot_input_example.png)

Пишите по примеру, который бот показывает прямо в этом input. После отправки текста нужно дождаться следующего шага или ответа бота.
...
- На шаге `input` писать текст одним сообщением.
...
- Дробят ответ на шаге `input` на несколько сообщений.
