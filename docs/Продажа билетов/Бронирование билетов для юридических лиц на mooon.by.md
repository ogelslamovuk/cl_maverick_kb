...
- Сеанс должен начинаться более чем через 30 часов. Если до него остаётся 30 часов или меньше, вместо формы сайт показывает гостю окно **«Свяжитесь с менеджером»**.
- В одном заказе можно выбрать не более 10 билетов.
- При переходе к оплате по счёту завершается сессия гостя в личном кабинете. Никакие скидки, включая скидки программы лояльности, не применяются: счёт формируется по полной стоимости.

![Окно «Свяжитесь с менеджером»](../assets/media/ticket-corporate-bookings/corporate-booking-contact-manager.png)
