...
Когда нужно активировать один или несколько сертификатов из подготовленного Excel-файла или проверить одиночный сертификат перед активацией.
...
На странице также есть вкладка `Одиночный`. В ней отображается поле для 16-значного номера сертификата и действия `Поиск` и `Сбросить`.
