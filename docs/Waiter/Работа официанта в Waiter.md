...
### Модификаторы и комментарии к позиции

У некоторых блюд после добавления в чек доступна кнопка **«Модификаторы»**. Через неё официант выбирает дополнительный параметр блюда или добавляет комментарий для кухни. Если модификатор обязательный, позиция не добавляется в чек без выбора значения.

Настройку модификаторов и комментариев в Portal, их привязку к продуктам и работу с ними в заказе описывает [Модификаторы и комментарии к блюдам в Waiter](Модификаторы%20и%20комментарии%20к%20блюдам%20в%20Waiter.md).
